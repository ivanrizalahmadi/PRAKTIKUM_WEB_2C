...
<div class="container">
    ...
    <form action="proses.php?aksi=ubah" method="post">
        ...
        <div class="radio-group">
            <input type="radio" name="jenis_kelamin" value="Laki-laki" id="laki" <?php if ($row['jenis_kelamin'] === 'Laki-laki') echo 'checked'; ?> required>
            <label for="laki">Laki-laki</label>
            
            <input type="radio" name="jenis_kelamin" value="Perempuan" id="perempuan" <?php if ($row['jenis_kelamin'] === 'Perempuan') echo 'checked'; ?> required>
